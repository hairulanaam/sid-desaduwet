...
<div class="container mx-auto px-4 mb-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
            <h2 class="text-2xl font-semibold text-center text-gray-800 mb-6">Form Pengajuan Surat Keterangan Tidak Mampu (Pendidikan)</h2>
            ...
            <form action="{{ route('suratpengantarsktm.submit') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="jenis_surat" name="jenis_surat" value="Surat Keterangan Tidak Mampu (Pendidikan)" readonly
                        class="w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100">
                </div>
