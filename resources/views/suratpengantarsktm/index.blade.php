@extends('layouts.app', [
    ...
    'active' => 'suratpengantarsktm',
    'page' => 'suratpengantarsktm',
])
...
@section('content')
    <section class="relative bg-cover w-full h-[50vh] bg-hero flex mb-10"
        ...
        <div class="justify-center items-center text-center mx-auto text-white flex z-10 flex-col">
            <p class="sm:text-5xl text-2xl font-bold mt-3">Surat Keterangan Tidak Mampu Desa
    ...
    <div class="container mx-auto px-4 mb-8">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                <h2 class="text-2xl font-semibold text-center text-gray-800 mb-6">Form Pengajuan Surat Keterangan Tidak Mampu
                    (Pendidikan)</h2>

                <form action="{{ route('suratpengantarsktm.submit') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="jenis_surat" name="jenis_surat" value="Surat Keterangan Tidak Mampu (Pendidikan)"
