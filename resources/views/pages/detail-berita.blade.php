@extends('layouts.app', [
    'title' => 'Detail Berita Desa Duwet',
    'active' => 'detailberita',
    'page' => 'detailberita',
])
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-4">
                        ...
                        <div class="flex gap-2 items-center">
                            <img src="{{ asset('assets/vector/user.png') }}" alt="Penulis"
                                class="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 object-contain">
                            <p class="text-xs sm:text-sm md:text-base text-[#b0b0b0]">{{ $berita->penulis }}</p>
                        </div>
                    </div>
                    
                    <h1 class="text-xl sm:text-2xl md:text-3xl font-bold mt-6 text-gray-800">{{ $berita->judul }}</h1>
