...
@section('content')
    <section class="relative bg-cover w-full h-[50vh] bg-hero flex"
        ...
        <div class="justify-center items-center mx-auto text-white flex z-10 flex-col">
            <p class="sm:text-5xl text-3xl font-bold mt-3">Sambutan Kepala Desa
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        @if ($sambutan)
            ...
            @php
                ...
                $kalimatArray = preg_split('/(?<=[.!?])\s+/', e($sambutan->deskripsi));
            ...
            <h1 class="mt-6 text-gray-600 text-lg text-left font-semibold">Wassalamu’alaikum warahmatullahi wabarakatuh.</h1>
