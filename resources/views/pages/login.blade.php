        ...
        <form class="px-6 py-4 space-y-4">
            ...
            <div>
                ...
                <input type="text" id="nik" name="nik" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#2dba48] bg-[#EBF2FA]"
            ...
            <div>
                ...
                <div class="flex">
                    <input type="password" id="password" name="password"
                        class="flex-grow px-3 py-2 border border-r-0 border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#2dba48] bg-[#EBF2FA]"
