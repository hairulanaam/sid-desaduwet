@extends('layouts.app', [
    'title' => 'Profil Bumdes Desa Duwet',
    'active' => 'profilbumdes',
    'page' => 'profilbumdes',
])
...
@section('content')
    <section class="relative bg-cover w-full h-[50vh] bg-hero flex"
        ...
        <div class="justify-center text-center items-center mx-auto text-white flex z-10 flex-col">
            <p class="sm:text-5xl text-3xl font-bold mt-3">Profil Bumdes Desa
        ...
        <div class="lg:col-span-2">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                @if ($profilbumdes)
                    ...
                    <h1 class="uppercase text-2xl sm:text-3xl lg:text-4xl font-semibold text-gray-800 text-center mt-6">
                        {{ $profilbumdes->judul }}</h1>
                    @php
                ...
                @else
                    <p class="text-gray-600 text-lg">Belum ada data profil bumdes yang tersedia.</p>
                @endif
            </div>
        </div>
