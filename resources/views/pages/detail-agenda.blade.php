    ...
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2">
            <div class="bg-white shadow-md rounded-lg p-6">
                <h1 class="text-3xl font-bold text-gray-800">{{ $agenda->judul }}</h1>
                <table class="mt-4 w-full text-lg text-gray-700">
                    <tr class="border-b">
                        <td class="py-2 font-semibold w-1/4">Tanggal</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ \Carbon\Carbon::parse($agenda->tanggal)->translatedFormat('l, d F Y') }}</td>
                    </tr>
                    <tr class="border-b">
                        <td class="py-2 font-semibold">Jam</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ \Carbon\Carbon::parse($agenda->jam)->format('H:i') }} WIB</td>
                    </tr>
                    <tr class="border-b">
                        <td class="py-2 font-semibold">Agenda</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $agenda->agenda ?? '-' }}</td>
                    </tr>
                    <tr class="border-b">
                        <td class="py-2 font-semibold">Lokasi</td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $agenda->lokasi }}</td>
                    </tr>
                    <tr>
                        <td class="py-2 font-semibold">Petugas </td>
                        <td class="py-2">:</td>
                        <td class="py-2">{{ $agenda->petugas ?? '-' }}</td>
                    </tr>
                </table>
            </div>
        </div>
