            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="flex items-center gap-4 pt-4">
                    <div class="flex gap-1 items-center">
                        ...
                        <p class="text-[15px] text-[#b0b0b0]">{{ \Carbon\Carbon::parse($galeri->tanggal)->translatedFormat('l, d F Y') }}
                        </p>
                    </div>
                    <div class="flex gap-1 items-center">
                ...
                <h1 class="text-3xl font-bold mt-6 text-gray-800">{{ $galeri->judul }}</h1>
