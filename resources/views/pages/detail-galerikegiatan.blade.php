@extends('layouts.app', [
    'title' => 'Detail Galeri Kegiatan Desa Duwet',
    'active' => 'detailgaleri',
    'page' => 'detailgaleri',
])
<style>
...
@section('content')
    ...
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- KONTEN DETAIL GALERI KEGIATAN -->
        <div class="lg:col-span-2">
            <div class="bg-white shadow-md rounded-lg p-6">

                <img src="{{ asset('storage/' . $galeri->gambar) }}"
                    alt="{{ $galeri->judul }}"
                    class="rounded-lg shadow-lg w-full h-auto object-cover md:h-96 lg:h-[500px]">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-4">
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="text-xs sm:text-sm md:text-base text-[#b0b0b0]">
                        ...
                        <div class="flex gap-2 items-center">
                            <img src="{{ asset('assets/vector/user.png') }}" alt="Penulis"
                                class="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 object-contain">
                            <p class="text-xs sm:text-sm md:text-base text-[#b0b0b0]">{{ $galeri->penulis }}</p>
                        </div>
                    </div>
                    
                    <h1 class="text-xl sm:text-2xl md:text-3xl font-bold mt-6 text-gray-800">{{ $galeri->judul }}</h1>
                    
                    <p class="mt-3 text-sm sm:text-base md:text-lg text-gray-600 text-justify">
                        {{ $galeri->deskripsi }}
                    </p>                    
                <!-- Container utama -->
