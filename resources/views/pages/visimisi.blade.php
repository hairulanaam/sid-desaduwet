...
@section('content')
    <section class="relative bg-cover w-full h-[50vh] bg-hero flex"
        ...
        <div class="justify-center text-center items-center mx-auto text-white flex z-10 flex-col">
            <p class="sm:text-5xl text-3xl font-bold mt-3">Visi Misi Desa
    ...
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <!-- Bagian VISI -->
                <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 text-center">VISI</h1>
                <p class="uppercase mt-3 text-gray-600 text-base sm:text-lg md:text-xl text-center font-semibold">
                    {{ $visiMisi->visi ?? 'Data tidak tersedia' }}
                </p>

                <!-- Bagian MISI -->
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold mt-6 text-gray-800 text-center">MISI</h2>
                <p class="mt-3 text-gray-600 text-base sm:text-lg md:text-xl text-justify font-semibold">
                    Dalam rangka mencapai visi tersebut di atas, dirumuskan sejumlah misi sebagai berikut:
                </p>

                <ul class="mt-4 text-gray-600 text-base sm:text-lg md:text-xl list-decimal list-inside space-y-3">
                ...
                @if ($visiMisi && $visiMisi->file_path)
                    <div class="mt-10 bg-blue-100 p-4 rounded-lg text-center">
                        <p class="text-base sm:text-lg md:text-xl text-gray-700 font-semibold">
                            Download Formulir Visi & Misi ->
                            <a href="{{ asset('storage/' . $visiMisi->file_path) }}" target="_blank"
                                class="text-blue-600 font-bold hover:underline">Download</a>
                        </p>
                    </div>
