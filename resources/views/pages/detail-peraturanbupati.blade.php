@extends('layouts.app', [
    ...
    'active' => 'detailperaturangubupati',
...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white shadow-md rounded-lg p-6 mt-10 max-w-5xl mx-auto">
            ...
            <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6">{{ $peraturanbupati->nama_data }}</h1>

            <div class="overflow-x-auto">
                <div class="w-[100vw] md:w-[90vw] lg:max-w-4xl mx-auto overflow-hidden rounded-lg shadow-lg border">
                    <iframe id="pdfViewer" src="{{ asset('storage/' . $peraturanbupati->file_path) }}#view=FitH&zoom=100"
