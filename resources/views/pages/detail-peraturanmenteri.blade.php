...
@section('content')
    <div class="container mx-auto px-6 py-12">
        <div class="bg-white shadow-md rounded-lg p-6 mt-10">
            ...
            <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">{{ $peraturanmenteri->nama_data }}</h1>

            <div class="flex justify-center">
                <iframe id="pdfViewer" src="{{ asset('storage/'.$peraturanmenteri->file_path) }}" class="w-full" frameborder="0"></iframe>
            </div>
