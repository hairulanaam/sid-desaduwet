                    ...
                    <tbody class="bg-white">
                        @forelse ($golonganDarah as $index => $golonganDarahItem)
                            <tr>
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{ $golonganDarahItem->laki_laki }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $golonganDarahItem->perempuan }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $golonganDarahItem->jumlah_penduduk }}</td>
                            </tr>
                        @empty
                            <tr>
