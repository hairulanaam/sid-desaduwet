@extends('layouts.app', [
    'title' => 'Direksi Bumdes Desa Duwet',
    'active' => 'direksibumdes',
    'page' => 'direksibumdes',
])
...
@section('content')
    @php
        ...
        $struktur = DireksiBumdes::latest()->first();
    @endphp
    ...
    <section class="relative bg-cover w-full h-[50vh] flex items-center justify-center"
        ...
        <div class="justify-center text-center items-center mx-auto text-white flex z-10 flex-col">
            <p class="sm:text-5xl text-3xl font-bold mt-3">Direksi Bumdes Desa
                                ...
                                @if ($struktur && count($struktur->anggota))
                                    @foreach ($struktur->anggota as $index => $anggota)
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="uppercase border border-gray-300 px-4 py-2">{{ formatText($anggota['nama_lengkap']) }}</td>
                                            <td class="uppercase border border-gray-300 px-4 py-2 text-center">{{ $anggota['sk_nomor'] ?? '-' }}</td>
                                            ...
                                            <td class="uppercase border border-gray-300 px-4 py-2 text-center">{{ formatText($anggota['jabatan']) }}</td>
