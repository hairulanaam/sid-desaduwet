...
class SuratKeteranganDomisiLembagaController extends Controller
{
    public function index()
    {
        ...
        return view('suratketerangandomisililembaga.index');
    }
    ...
    public function submit(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard')->with('success', 'Pengajuan Surat Domisi Lembaga berhasil dikirim.');
        } catch (\Exception $e) {
