...
class SuratPengantarIjinKeramaianController extends Controller
{
    public function index()
    {
        ...
        return view('suratpengantarijinkeramaian.index');
    }
    ...
    public function submit(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard')->with('success', 'Pengajuan Surat Pengantar Ijin Keramaian berhasil dikirim.');
        } catch (\Exception $e) {
