...
class SuratPengantarSKTMController extends Controller
{
    public function index()
    {
        ...
        return view('suratpengantarsktm.index');
    }
    ...
    public function submit(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard')->with('success', 'Pengajuan Surat Pengantar SKTM berhasil dikirim.');
        } catch (\Exception $e) {
